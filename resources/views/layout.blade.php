...
<body class="home blog halimthemes halimmovies">

    <header id="" class="container">
        <div class="">
            <div class="" id="" style="margin-left: -15px; margin-right: 5px;">
                <div class="col-md-16">
                    <a href="/portal/"><img src="/imgs/Banner_DauTieng.png" type="application/x-shockwave-flash"
                            style="width:100%;" /></a>
                    <!-- <div class="language" style="height:30px;">
                        <a style="color: red" href="/portal/ChangeLanguage/ChangeLanguage?culture=vi">
                            Vi
                        </a>
                        <a style="color: blue" href="/portal/ChangeLanguage/ChangeLanguage?culture=en">
                            En
                        </a>
                    </div> -->
                </div>
